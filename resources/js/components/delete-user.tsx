            ...
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Depois que sua conta for excluída, todos os seus recursos e dados também serão excluídos permanentemente. Insira sua senha
                            para confirmar que você gostaria de excluir sua conta permanentemente.
                        </DialogDescription>
